...
from .views import home_view, AccountBedsView, create_occupy_ward, day_info, delete_occupy_instance, edit_occupy_ward, logout_view, login_view, error_page, autocomplete_patient
...
urlpatterns = [
    ...
    path('<str:ward_slug>/edit-occupy-ward/<int:pk>/', edit_occupy_ward, name='edit_occupy_ward'),
    path('delete/<int:pk>/', delete_occupy_instance, name='delete_occupy_instance'),
    path('autocomplete-patient/<slug:department_slug>/', autocomplete_patient, name='autocomplete-patient'),
